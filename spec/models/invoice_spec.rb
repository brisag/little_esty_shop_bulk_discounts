...
RSpec.describe Invoice, type: :model do
  ...
  describe "instance methods" do
    describe "total_revenue" do
      it "gets total revenue without discounts" do
    ...
    describe "total_revenue" do
      it "revenue_with_discount" do
        @merchant1 = Merchant.create!(name: 'Hair Care')
        @discount1 = Discount.create!(percent_discount: 0.20, quantity_threshold: 1, merchant_id: @merchant1.id)
        @item_8 = Item.create!(name: "Butterfly Clip", description: "This holds up your hair but in a clip", unit_price: 5, merchant_id: @merchant1.id)
        ...
        expect(@invoice_1.calculate_total_revenue_with_discounts).to eq(16.0)
        end
    end
    ...
    #
    #     expect(@invoice_1.find_discount).to eq(@invoice_1.items)
    #   end
    # end
  end
end
